...
public class SdgSpecification {

	/*
	 * private SearchCriteria criteria;
	 * 
	 * @Override public Predicate toPredicate (Root<User> root, CriteriaQuery<?>
	 ...
	 * (criteria.getOperation().equalsIgnoreCase("<")) { return
	 * builder.lessThanOrEqualTo( root.<String> get(criteria.getKey()),
	 * criteria.getValue().toString()); } else if
